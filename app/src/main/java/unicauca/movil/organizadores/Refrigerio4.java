...
public class Refrigerio4 extends NFCActivity implements HttpAsyncTask.OnResponseListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_refrigerio4);
    }

    @Override
    protected void onNFCData(UserRequest request) {
        String json = gson.toJson(request);
        String url = "http://192.168.43.232:8080/ref4/public/index.php/ref";
