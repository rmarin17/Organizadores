...
public class RefrigerioActivity extends NFCActivity implements HttpAsyncTask.OnResponseListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_refrigerio);
    }
    ...
    protected void onNFCData(UserRequest request) {
        ...
        String url = "http://192.168.43.232:8080/ref1/public/index.php/ref";
